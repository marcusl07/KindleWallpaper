...
require_pattern "$DISPLAY_TOPOLOGY_COORDINATOR_FILE" 'CGDisplayRegisterReconfigurationCallback' "CoreGraphics display callback registration"
require_pattern "$DISPLAY_TOPOLOGY_COORDINATOR_FILE" 'CGDisplayRemoveReconfigurationCallback' "CoreGraphics display callback removal"
require_pattern "$DISPLAY_TOPOLOGY_COORDINATOR_FILE" 'defaultRestoreDebounceInterval' "default restore debounce interval"
require_pattern "$DISPLAY_TOPOLOGY_COORDINATOR_FILE" 'defaultConfirmationRestoreDelay' "default confirmation restore delay"
...
require_pattern "$DISPLAY_TOPOLOGY_COORDINATOR_FILE" 'handleCoreGraphicsDisplayReconfiguration' "CoreGraphics display reconfiguration handler"
require_pattern "$DISPLAY_TOPOLOGY_COORDINATOR_FILE" 'beginConfigurationFlag' "CoreGraphics begin-phase filtering"
